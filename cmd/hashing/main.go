...
import (
	...
	hashingapi "github.com/hitman99/hashing"
...
func main() {
	...
	var (
		hashingSvc hashing.Service
	)
	{
		hashingSvc = hashingapi.NewHashing(logger)
	}

	// Wrap the services in endpoints that can be invoked from other services
	// potentially running in different processes.
	var (
		hashingEndpoints *hashing.Endpoints
	)
	{
	...
	case "0.0.0.0":
		{
			...
			handleHTTPServer(ctx, u, hashingEndpoints, &wg, errc, logger, *dbgF)
		}
